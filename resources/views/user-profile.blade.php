      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{ asset('img/perfil.jpg') }}" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2">{{ $user->rol }} | {{ $user->nombres }}</span>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $user->nombres }} {{ $user->apellidos }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Empresa</div>
                    <div class="col-lg-9 col-md-8">Asegacar, Pitalito</div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Tipo y número de documento</div>
                    <div class="col-lg-9 col-md-8">{{ $user->tipo_documento }} {{ $user->numero_documento }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Celular</div>
                    <div class="col-lg-9 col-md-8">(57) {{ $user->telefono }}</div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="{{ url('profile/'.$user->id) }}" method="post">
                      ...
                      @csrf
                    <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Imagen</label>
                      <div class="col-md-8 col-lg-9">
                        <img src="{{ asset('img/perfil.jpg') }}" alt="Profile">
                        <div class="row mt-3 gap-3">
                            <input id="foto" name="foto" type="file" class="form-control form-control-sm w-50">
                            <form action="{{ url('profile/'.$user->id) }}" method="post" class="w-50">
                                @method('DELETE')
                                @csrf
                                <button type="submit" class="btn btn-danger btn-sm w-25">Eliminar</button>
                            </form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nombres" type="text" class="form-control" id="nombres" value="{{ $user->nombres }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="company" type="text" class="form-control" id="company" value="Asegacar, Pitalito">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select name="rol" id="rol" class="form-select">
                          ...
                          <option value="3">Auxiliar de calidad</option>
                          <option value="4">Auxiliar operativo</option>
                    ...
                    <div class="row mb-3">
                      <label for="numero_documento" class="col-md-4 col-lg-3">Número de documento</label>
                      <div class="col-md-8 col-lg-9">
                        <input type="number" class="form-control" name="numero_documento" id="numero_documento" value="{{ $user->numero_documento }}">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      <label for="currentPassword" class="col-md-4 col-lg-3 col-form-label">Clave anterior</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Repetir Nueva Clave</label>
                      <div class="col-md-8 col-lg-9">
